        ...
        <div className="p-4 sm:ml-64">
          <div className="grid grid-cols-5 gap-4">
            <div>
              <button
                type="button"
                className="text-white focus:outline-none focus:ring-4 font-medium rounded-full text-sm px-12 py-2.5 text-center me-2 mb-2 bg-blue-600 hover:bg-blue-700 focus:ring-blue-800"
              >
                Mulai Bertanya
              </button>
            ...
            <div className="col-start-2 col-end-6">
              <div className="w-full p-4 mb-4 border-2 border-solid border-blue-500 rounded-xl">
                ...
                <div className="flex justify-between mb-5">
                  ...
                  <div>
                    <h2 className="text-gray-400">2 hari yang lalu</h2>
                  </div>
                </div>
                <p className="mb-5">
          ...
          <div className="flex justify-around">
            <button className="text-blue-700 focus:outline-none font-medium rounded-full text-sm px-12 py-2.5 text-center me-2 mb-2 hover:bg-blue-500 border border-gray-400">Previous</button>
            <button className="text-blue-700 focus:outline-none font-medium rounded-full text-sm px-12 py-2.5 text-center me-2 mb-2 hover:bg-blue-500 border border-gray-400">Next</button>
          </div>
        </div>
      </div>
    </>
