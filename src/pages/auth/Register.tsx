                            ...
                            <div className="w-1/2 overflow-hidden ml-20 mr-36">
                                ...
                                <form method="POST" className="w-full" id="login-form">
                                    <div className="relative mb-6 border-b-4 last:mb-0">
                                        ...
                                        <input type="text" name="name" id="name" placeholder="Name" className='focus:outline-none'/>
                                    </div>
                                    <div className="relative mb-6 border-b-4 last:mb-0">
                                        <label htmlFor="email"></label>
                                        <input type="text" name="email" id="email" placeholder="Email" className='focus:outline-none'/>
                                    </div>
                                    <div className="relative mb-6 border-b-4 last:mb-0">
                                        <label htmlFor="password"></label>
                                        <input type="text" name="password" id="password" placeholder="Password" className='focus:outline-none'/>
                                    </div>
                                    <div className="relative mb-6 last:mb-0 text-center">
                                        <input type="submit" name="create" id="create" className="inline-block bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-6" value="Create" />
                                    </div>
                                </form>
                            </div>
